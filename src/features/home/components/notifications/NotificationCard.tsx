...
export default function NotificationCard({
	...
	return (
		<TouchableOpacity
			className={`w-full  rounded-2xl p-4 gap-6  flex-row items-center ${!isRead ? "bg-secondary/20" : "bg-white"}`}
			onPress={onClick}
		>
			<View className="w-10 h-10 rounded-full bg-primary flex-shrink-0" />
